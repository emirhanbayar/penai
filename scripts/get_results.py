...
def parse_args():
    ...
    parser.add_argument("--device", type=str, default="cuda", help="Device to run diarization on")
...
def create_diarizer(diarizer_name, args):
    if diarizer_name == "pyannote-ours":
        return PyannoteDiarizer(device=args.device, feature_clustering_threshold=args.feature_clustering_threshold, ema_alpha=args.ema_alpha)
